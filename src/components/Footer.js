      ...
      <Container fluid className="bg-secondary">
        <Container data-bs-theme="dark">
          <Row className="py-5">
            ...
            <Col lg={4} sm={6} xs={12}>
              <h6 className="text-center text-md-start mt-4 mt-lg-0">
                Services
              </h6>
            </Col>
          </Row>
        ...
        <Container fluid id="copyright">
          <Container>
            <Row className="py-2">
              <Col xs={12} sm={4}>
                <p className="text-white text-center text-md-start m-0">
                  &copy; {currYear} Shiv Engineering Designed By JD Bisht.
                </p>
              </Col>
              <Col xs={12} sm={8}>
